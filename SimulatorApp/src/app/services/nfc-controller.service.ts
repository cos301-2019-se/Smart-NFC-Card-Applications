/**
*	File Name:	    nfc-controller.service.ts
*	Project:		    Smart-NFC-Application
*	Orginization:	  VastExpanse
*	Copyright:	    © Copyright 2019 University of Pretoria
*	Classes:	      NfcControllerService
...
*
*	Functional Description:   This class provides an NFC service to the rest of the simulator
*	Error Messages:   “Error”
*	Assumptions:  That the injectables are working
*	Constraints: 	None
*/
